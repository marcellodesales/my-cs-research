  ...
  <DIV align=center><br>
    <TABLE class="tabelaMaior" cellSpacing=0 cellPadding=0 width=748 border="0" height="0">
      ...
      border=0>
		...
		<form method="post" action="../servlet/br.ufal.graw.web.user.DeleteLink"> 
          <table bgcolor="a0b8c8" align="center" border="0" cellpadding="2" cellspacing="0" width="90%">
    <tr><td><table bgcolor="#eeeeee" border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      <td bgcolor="#ffffff" align="center"> 
        <table border="0" cellspacing="6" cellpadding="6" bgcolor="ffffff" width="100%">
          <tr bgcolor="eeeeee"> 
            <td id=headerSimplesFont align="center"> <img src="../sources/images/delete.gif"> Deseja realmente excluir o link?</td>
          </tr>
          <tr bgcolor="eeeeee"> 
