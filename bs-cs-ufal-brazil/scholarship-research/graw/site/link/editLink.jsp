...
<%
	...
	Link  link	= 	new Link( linkID , (DatabaseLayer)session.getAttribute("database"));
	LinkCategory linkCategory = new LinkCategory(link.getCategoryID(),(DatabaseLayer)session.getAttribute("database"));
%>
...
%>
                      <BR>
                      <form method="post" action="<%=servletDir+"br.ufal.graw.web.user.EditLink"%>">
                        <table bgcolor="a0b8c8" align="center" border="0" cellpadding="2" cellspacing="0" width="90%">
                          <tr> 
                            <td> 
                                ...
                                <tr> 
                                  <td bgcolor="#ffffff" align="center"> 
                                    <table border="0" cellspacing="6" cellpadding="6" bgcolor="ffffff" width="100%">
                                      <tr bgcolor="eeeeee"> 
                                        <td id=headerSimplesFont align="center"><img src="../sources/images/edit.gif"> 
                                          Editar Link </td>
                                      </tr>
                                      <tr bgcolor="eeeeee"> 
                                          ...
                                          <table width="81%" border="0">
                                            ...
                                            <tr> 
                                              ...
                                              <td width="75%" height="49"> 
                                                <input type="text" name="linkTitle" maxlength="50" size="60" value="<%= link.getTitle() %>">
                                              </td>
                                            </tr>
                                            <tr> 
                                              <td width="25%"> 
                                              ...
                                              <td width="75%"> 
                                                <input type="text" name="linkAddress" maxlength="200" size="60" value="<%= link.getAddress() %>">
                                              </td>
                                            </tr>
                                            <tr> 
                                              <td width="25%"> 
                                              ...
                                              <td width="75%"> 
                                                <textarea name="linkDescription" rows="5" cols="52"><%= link.getDescription() %></textarea>
                                              </td>
                                            </tr>
                                            <tr> 
                                              <td colspan="2"> 
