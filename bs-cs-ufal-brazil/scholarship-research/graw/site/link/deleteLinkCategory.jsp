  ...
  <DIV align=center><br>
    <TABLE class="tabelaMaior" cellSpacing=0 cellPadding=0 width=748 border="0" height="0">
      ...
      border=0>
		...
		<form method="post" action="<%= servletDir+"br.ufal.graw.web.user.DeleteLinkCategory" %>"> 
    ...
    <tr>
      <td bgcolor="#ffffff" align="center"> 
        <table border="0" cellspacing="6" cellpadding="6" bgcolor="ffffff" width="100%">
          <tr bgcolor="eeeeee"> 
                                        <td id=headerSimplesFont align="center"> 
                                          <img src="../sources/images/delete.gif"> 
                                          Deseja realmente a pasta?</td>
          </tr>
          <tr bgcolor="eeeeee"> 
            <td id=corpoSimples valign="top" align="center">
                                          <table width="100%" border="0">
                                            ...
                                            <tr> 
                                              ...
                                              <td width="75%" height="49"> <%= community.getTitle() %></td>
                                            </tr>
                                            <tr> 
                                              <td>&nbsp; </td>
                                              <td>Possui <b><%= linkCategory.getQuantity() %></b> links.</td>
                                            </tr>
                                            <tr> 
                                              <td colspan="2"> 
                                                <div align="right"> 
