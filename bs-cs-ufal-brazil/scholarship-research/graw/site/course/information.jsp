		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
          ...
          <p>&nbsp;</p><center>
                  <table class=tabelaSimples cellspacing=0 cellpadding=3 width="92%">
                    <tbody> 
                    <tr> 
                      <td id=headerSimplesFont><%=course.getName() %></td>
                    </tr>
                    <tr> 
                      <td id=corpoSimples height="0"><%=course.getDescription()%><br>
                      </td>
                    </tr>
                    <tr> 
                      <td id=headerSimplesFont height="0">Programa</td>
                    </tr>
                    <tr> 
                            <td id=corpoSimples height="23"><%=course.getProgram()%></td>
                    </tr>
                    <tr> 
                      <td id=headerSimplesFont height="0">Refer&ecirc;ncias Bibliogr&aacute;ficas</td>
                    </tr>
                    <tr> 
                      <td id=corpoSimples height="0"><%=course.getBibliography()%></td>
                    </tr>
                    <tr>
                      <td id=headerSimplesFont height="0">Carga Hor&aacute;ria: - <%=course.getHours()%></td>
                    </tr>
                    </tbody> 
                  </table>
                </center>
