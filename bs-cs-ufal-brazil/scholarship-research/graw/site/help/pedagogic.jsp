                          ...
                          <tr> 
                            <td height="0"> 
                              <div align="right"><!-- #BeginEditable "directory" --><b>Ajuda 
								&#149; Pedag&oacute;gico</b><!-- #EndEditable --></div>
                            </td>
                          </tr>
                          <tr> 
      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
              ...
              <td valign="top" width="78%"> 
                ...
                <p><br>
                  Cada curso, grupo e disciplina possui uma sess&atilde;o &quot;Pedag&oacute;gico&quot; 
                  cuja finalidade &eacute; compartilhar materiais pedag&oacute;gicos 
                  entre os participantes.</p>
                <p>Os recursos dessa sess&atilde;o est&atilde;o sujeitos as seguintes 
                  regras:</p>
                <p><b>No contexto do curso ou disciplina.</b><br>
                  As &uacute;nicas pessoas que podem submeter material s&atilde;o 
                  os professores e monitores do curso ou disciplina em quest&atilde;o.<br>
                  Al&eacute;m disso os professores e monitores podem monitorar 
                  os materiais utilizados pelos grupos que est&atilde;o subordinados 
                  ao curso ou disciplina. Por exemplo suponha que existe um curso 
                  X e que existe um grupo Y que &eacute; subordinado a X. Logo 
                  o professor ou monitor de X pode monitorar os materiais de Y.</p>
                <p><b>No contexto do grupo.</b><br>
                  Somente membros do grupo podem submeter materiais ao grupo.</p>
                <!-- #EndEditable --></td>
                  </tr>
                </table>
          <BR>
