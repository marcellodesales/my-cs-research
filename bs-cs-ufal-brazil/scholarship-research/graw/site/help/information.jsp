                          ...
                          <tr> 
                            <td height="0"> 
                              <div align="right"><!-- #BeginEditable "directory" --><b>Ajuda 
								&#149; Informa&ccedil;&otilde;es Pessoais</b><!-- #EndEditable --></div>
                            </td>
                          </tr>
                          <tr> 
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --><br>
					  A se&ccedil;&atilde;o <i>Minhas Informa&ccedil;&otilde;es</i> 
					  &eacute; destinada a configura&ccedil;&otilde;es personalizadas. 
					  Voc&ecirc; altera suas configura&ccedil;&otilde;es pessoas 
					  e acessa seus compromissos na agenda, al&eacute;m de modificar 
					  a senha de acesso. Para a sua seguran&ccedil;a sua senha 
					  &eacute; criptografada e nem mesmo n&oacute;s poderemos 
					  saber qual &eacute;.<br>
                      <ul>
                        <li> Pessoais: dados pessoais referentes a sua pessoa;</li>
                        <li>Mudar senha: mudar senha de acesso;</li>
                        <li>Agenda: agenda pessoal e compartilhada com todas as 
                          comunidades participantes.</li>
                      </ul>
                      <br>
                      Al&eacute;m de compromissos pessoais, sua agenda mostrar&aacute; 
                      compromissos das comunidades em que voc&ecirc; participa. 
                      Os respons&aacute;veis por aquelas comunidades poder&atilde;o 
                      agendar algo de importante sobre a comunidade, desde uma 
                      sess&atilde;o de chat a novas datas de atividades relacionadas 
                      a comunidade etc. <!-- #EndEditable --></td>
                  </tr>
                </table>
          <BR>
              </td>
