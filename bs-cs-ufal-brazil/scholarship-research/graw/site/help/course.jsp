      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
              ...
              <td valign="top" width="78%"> 
                ...
                <p><br>
                  Aqui voc&ecirc; escolhe e acessa os cursos e disciplinas nas 
                  quais voc&ecirc; se interessa.</p>
                <p>Se voc&ecirc; &eacute; um professor voc&ecirc; pode submeter 
                  um novo curso ou disciplina.</p>
                <!-- #EndEditable --></td>
                  </tr>
                </table>
          <BR>
