                    ...
                    <td  valign=center align=middle height=65 background="../sources/images/gr03.jpg"> 
                      <div  id="textoBlue" align="right"> 
                        <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="0"> 
                              <div align="right"><!-- #BeginEditable "directory" --><b>Ajuda 
								&#149; Comunica&ccedil;&atilde;o</b><!-- #EndEditable --></div>
                            </td>
                          </tr>
                          <tr> 
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --> 
					  <p><br>
						Cada comunidade possui v&aacute;rias ferramentas de comunica&ccedil;&atilde;o, 
						cuja finalidade &eacute; estimular integra&ccedil;&atilde;o 
						e a troca de experi&ecirc;ncias entre os participantes.</p>
					  <p><b>F&oacute;rum de discuss&atilde;o.</b><br>
						O f&oacute;rum &eacute; uma &aacute;rea para discuss&atilde;o 
						de assuntos relacionados a comunidade. Cada pergunta feita 
						pode ser respondida quantas vezes forem necess&aacute;rias. 
						As respostas s&atilde;o listadas uma abaixo da outra, 
						na ordem em que foram criadas.</p>
					  <p><b>Chat / WhiteBoard</b><br>
						O chat &eacute; uma poderosa ferramenta de discuss&atilde;o 
						em tempo real. Nela, alunos e professores podem marcar 
						discuss&otilde;es online. S&oacute; ser&atilde;o permitidos 
						nas salas alunos cadastrados na disciplina corrente.<br>
						O WhiteBoard surge como uma extens&atilde;o visando permitir 
						uma comunica&ccedil;&atilde;o gr&aacute;fica em tempo 
						real.</p>
					  <p><b>Email.</b><br>
						O email permite que o usu&aacute;rio envie emails diretamente 
						pela p&aacute;gina do graW.</p>
					  <!-- #EndEditable --></td>
                  </tr>
                </table>
          <BR>
...
<map name="Map2"> 
  <area shape="circle" coords="80,23,12" href="information.jsp">
  <area shape="circle" coords="149,22,13" href="comunication.jsp">
  <area shape="circle" coords="203,21,11" href="pedagogic.jsp">
  <area shape="circle" coords="260,22,11" href="course.jsp">
  <area shape="circle" coords="316,21,11" href="group.jsp">
  <area shape="circle" coords="368,21,10" href="index.jsp">
