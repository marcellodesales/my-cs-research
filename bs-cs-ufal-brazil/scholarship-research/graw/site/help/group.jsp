      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
              ...
              <td valign="top" width="78%"> 
                ...
                <p><br>
                  Voc&ecirc; pode criar grupos subordinados as disciplinas para 
                  discutir assuntos de interesse comum.</p>
                <p>Essa ferramenta tamb&eacute;m pode ser usada para auxiliar 
                  a comunica&ccedil;&atilde;o e a coordena&ccedil;&atilde;o de 
                  trabalhos em grupo.</p>
                <p>Cada grupo conta com ferramentas de comunica&ccedil;&atilde;o 
                  e pedag&oacute;gicas.</p>
                <!-- #EndEditable --></td>
                  </tr>
                </table>
          <BR>
