		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
          ...
          <div align="center"> <br>
		    <table width="90%">
              <tr>
				<td vAlign=top >
					<table width="100%" border="0" class="tabelaSimples">
						<tr>
							<td id=headerSimples>
								Objetivos
							</td>
            ...
            <table width="100%" border="0" class="tabelaSimples">
              <tr> 
                <td id=headerSimples colspan="4"><b>Membros</b></td>
              </tr>
			  	<%
				Enumeration members = group.getMembers();
				User member;
				boolean isAdministrator =  group.isAdministrator(user);
			  	while ( members.hasMoreElements() ){
					member = (User) members.nextElement(); %>
					<tr>		             
                		<td id=corpoSimples width="70%"><%=member.getName()%></td>
						<td id=corpoSimples> 	<%
							if (group.isAdministrator(member)){	%>
								<img src="../sources/images/administrator.gif" border="0" alt="Excluir Membro">	<%
							}	%>
						</td>
		                <td id=corpoSimples ><a href ="../email/index.jsp?userID=<%=member.getID()%>"><img src="../sources/images/email.gif" border="0" alt="Enviar Email"></a></td>
						<td id=corpoSimples >
						<%
						if ( isAdministrator ){	%>
			                <a href ="../servlet/br.ufal.graw.web.user.SignOutGroup?userID=<%=member.getID()%>"><img src="../sources/images/deleteUser.gif" border="0" alt="Excluir Membro"></a>	<%
						}	%>
						</td>
					</tr>	<% 
				}	%>
			...
			<table width="100%" border="0" class="tabelaSimples">
				...
				if ( ! isAdministrator ){	%>
	             <tr>					
	                <td id=corpoSimples><a href="../servlet/br.ufal.graw.web.user.SignOutGroup" class="Link"> Cancelar Assinatura. </a></td>
				</tr>
				<%}
				if ( isAdministrator ){	%>
					<tr>						
		                
                      <td id=corpoSimples> <a href="inviteMember.jsp" class="Link">Convidar 
                        usuários para o grupo. </a></td>
					</tr>
					<tr>
						
                <td id=corpoSimples><a href="../servlet/br.ufal.graw.web.user.SignOutGroup" class="Link"> Excluir Grupo </a> </td>
					</tr>	<%
				}	%>
			</table>
			</td>
