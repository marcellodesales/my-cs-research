...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" -->Grupos 
      de Pesquisa no graW<!-- #EndEditable --></b></font></td>
  </tr>
  <tr valign="top"> 
    <td height="276"> <!-- #BeginEditable "centro" --> Qualquer usu&aacute;rio 
      poder&aacute; ter acesso aos grupos de pesquisa, dependendo das pol&iacute;ticas 
      de acesso de cada um, definidas pelo respons&aacute;vel dos mesmo.<br>
      <br>
      <%
