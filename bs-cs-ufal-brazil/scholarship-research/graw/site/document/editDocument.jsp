...
<%
	Document document = new Document( request.getParameter("documentID") , (DatabaseLayer) session.getAttribute("database") );
%>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
              ...
              <td valign="top" width="78%"> 
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --> <BR><BR>
          <div align="center">
		   <form method="post" name="editDocument" action="../servlet/br.ufal.graw.web.user.EditDocument">
            <table width="50%" border="0" class="tabelaSimples">
                  <tr bgcolor="eeeeee"> 
                              <td id=headerSimplesFont colspan=2>&nbsp;<img src="../sources/images/edit.gif" width="16" height="16"> 
                                Editar Documento</td>
                  </tr>			
              <tr> 
                <td id="headersimples" 	width="41%">Documento:</td>
                <td id="corpoSimples" width="59%"> 
                  <input type="text" name="documentTitle" value="<%=document.getTitle() %>">
                </td>
              </tr>
              <tr> 
                <td id ="headerSimples" width="41%">Descri&ccedil;&atilde;o</td>
                <td id="corpoSimples" width="59%"> 
                    <textarea name="documentDescription" rows="4" cols="55"><%=document.getDescription() %></textarea>
                </td>
              </tr>
              <tr> 
                <td id="corpoSimples" colspan="2"> 
                  <div align="center"> 
                    ...
                    <input type="submit" name="Submit" value="Atualizar Dados" class="botao">
                  </div>
                </td>
              </tr>
            </table>
