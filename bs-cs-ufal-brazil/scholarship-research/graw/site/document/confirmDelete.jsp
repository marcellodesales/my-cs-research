  ...
  <DIV align=center><br>
    <TABLE class="tabelaMaior" cellSpacing=0 cellPadding=0 width=748 border="0" height="0">
      ...
      border=0>
		...
		<div align="center">
		   <form method="post" name="deleteDocument" action="../servlet/br.ufal.graw.web.user.DeleteDocument">
              
              <table width="50%" border="0" >
                <tr> 
                  <td id="headersimples" colspan="2">
                    <div align="center"> <img src="../sources/images/delete.gif" width="16" height="16">Deseja 
                      Realmente excluir o documento? </div>
                  </td>
                </tr>
                <tr> 
                  <td id="headersimples" 	width="41%">Documento:</td>
                  <td id="corpoSimples" width="59%"> <%=document.getTitle() %> 
                  </td>
                </tr>
                <tr> 
                  <td id ="headerSimples" width="41%">Descri&ccedil;&atilde;o</td>
                  <td id="corpoSimples" width="59%"> <%=document.getDescription() %> 
                  </td>
                </tr>
                <tr> 
