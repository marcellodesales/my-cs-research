...
<CENTER>
  <DIV align=center><br>
    <TABLE class="tabelaMaior" cellSpacing=0 cellPadding=0 width=748 border="0" height="0">
      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
		      ...
		      <form method="post" enctype="multipart/form-data" action="<%=servletDir+"br.ufal.graw.web.user.CreateNewDocument"%>">
    ...
    <tr>
      <td align="center"> 
                        <table border="0" cellspacing="6" cellpadding="6" width="100%" class="tabelaSimples">
                          <tr > 
            <td  id="headerSimples" align="center"> 
				<div align="left"><font face="arial" size="-1"><nobr><b><img src="../sources/images/new.gif" width="16" height="16"> 
					Novo Documento </b></nobr><nobr></nobr><nobr><b> 
                    <br>
					<font size="1">Tamanho M&aacute;ximo do Arquivo: <%=ServletUtility.DISK_SPACE_FOR_EACH_DISCIPLINE/(1024*1024)%>Mb 
				</font> </b></nobr></font> </div>
            </td>
          </tr>
          <tr > 
            <td id="corpoSimples" valign="top" align="center">
		      ...
		      <tr> 
                                              ...
                                              <td width="75%"><%= category.getTitle() %></td>
                                            </tr>
                      <tr> 
                        <td width="25%"> 
                      ...
                      <tr> 
                        ...
                        <td width="75%"> 
                          <input type="text" name="documentTitle" maxlength="50" size="60">
                        </td>
                      </tr>
                      <tr> 
                        <td width="25%"> 
                          <div align="right"><b>Documento:</b></div>
                        </td>
                        <td width="75%"> 
                          <p> 
                      ...
                      <tr> 
                        ...
                        <td width="75%"> 
                          <textarea name="documentDescription" rows="5" cols="52"></textarea>
                        </td>
                      </tr>
                      <tr> 
                        <td colspan="2"> 
