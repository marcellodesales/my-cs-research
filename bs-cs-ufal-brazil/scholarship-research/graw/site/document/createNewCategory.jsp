...
%>
<TITLE>graW - Gradua&ccedil;&atilde;o na Web - TCI/UFAL - Criação de novas pastas de links para a comunidade <%= community.getTitle() %></TITLE>
<!-- #EndEditable -->
...
<CENTER>
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --><br>
                      Para criar uma pasta, digite o nome e a descri&ccedil;&atilde;o 
                      da mesma e clique em <i>Criar Pasta,</i> ou em <i>Cancelar</i> 
                      para voltar a p&aacute;gina anterior.<br>
  <% 	String message = (String)session.getAttribute("message");
		...
		%>
                      <form action="<%=servletDir+"br.ufal.graw.web.user.CreateNewDocumentCategory" %>" method="POST">
                        <table width="342" border="0" align="center" cellpadding="1" cellspacing="1">
                          <tr> 
                            <td  id=headerSimplesFont colspan=2>&nbsp;Nova pasta 
			      de documentos</td>
                          </tr>
                          <tr> 
                            <td id=corpoSimples width="87"> 
                              <div align="right"><b>Título</b></div>
                            </td>
                            <td id=corpoSimples width="248"> &nbsp;&nbsp; 
                              <input type="text" name="title" size="30" maxlength="50" value="<%= title%>">
                            </td>
                          </tr>
                          <tr> 
                            <td id=corpoSimples width="87"> 
                              <div align="right"><b>Descrição</b></div>
                            </td>
                            <td id=corpoSimples width="248"> &nbsp;&nbsp; 
                              <input type="text" name="description" size="30" maxlength="200"  value="<%= description%>">
                            </td>
                          </tr>
                          <tr> 
                            <td id=corpoSimples colspan=2> 
                              <div align="right"> 
                                ...
                                <input type="button" value="Voltar" name="button" onClick="javascript:history.back()">
                              </div>
                            </td>
                          </tr>
                        </table>
