...
if (message==null){
	message="Detalhes desconhecidos.";
}
%>
...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" -->{title}<!-- #EndEditable --></b></font></td>
  </tr>
  <tr valign="top"> 
          ...
          <table width="50%" border="0">
            <tr> 
              <td id="headerSimples" class="tabelaSimples"> 
                <div align="center">Sucesso !</div>
              </td>
            </tr>
            <tr> 
              <td id="corpoSimples" class="tabelaSimples"> 
                <div align="center"><%=message%></div>
              </td>
            </tr>
          </table>
          <br>
		  <a href="<%=from%>">Voltar</a>
		  </div>
          <!-- #EndEditable --> 
    </td>
  </tr>
