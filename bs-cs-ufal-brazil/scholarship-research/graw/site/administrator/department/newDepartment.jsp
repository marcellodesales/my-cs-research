...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr valign="top"> 
    <td height="276">
      ...
      <p><br>
        Primeiramente, escolha dentre de uma das institui&ccedil;&otilde;es abaixo 
        a que ter&aacute; o novo departamento.</p>
      <form name="newInstitute" action="newDepartment2.jsp" method="POST">
...
%>			  
          ...
          <tr> 
            <td colspan="4"> 
              <div align="right"> 
                <input type="submit" value="Criar Novo!" name="submit">
