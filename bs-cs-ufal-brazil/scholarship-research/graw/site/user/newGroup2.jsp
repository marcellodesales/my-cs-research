...
<TITLE>graW - Gradua&ccedil;&atilde;o na Web - Proposta de novo grupo</TITLE>
...
<%
		String communityIDGroup = request.getParameter("communityIDGroup");
		boolean createAssociatedGroup = (communityIDGroup != null);

		String subcategoryID = request.getParameter("subcategoryID");
		if (subcategoryID == null)
			subcategoryID = (String)session.getAttribute("subcategoryID");
		CommunitySubcategory commsub;
		
		Community commGroup = null;
		AcademicUser academicUser = null;
		if  (createAssociatedGroup){
				session.setAttribute("communityIDGroup",communityIDGroup);
				commGroup = AbstractCommunity.getRealCommunity(communityIDGroup,database);
				commsub = new CommunitySubcategory(commGroup.getSubcategoryID(),database);		
				academicUser = (AcademicUser)user;
				session.setAttribute("subcategoryID",commGroup.getSubcategoryID());
		} else {
				commsub = new CommunitySubcategory(subcategoryID,database);		
				session.setAttribute("subcategoryID",subcategoryID);
		}
		
		String category = (createAssociatedGroup) ? "Área de Conhecimento" : "Categoria";
		String subcategory = (createAssociatedGroup) ? "Sub-Área de Conhecimento" : "Subcategoria";
                      ...
                      <form action="../servlet/br.ufal.graw.web.user.CreateNewGroup" method="Post">
                        <div align="center"> 
                          <table width="80%" border="0">
                            ...
                            <% 	String commKind =  (commGroup instanceof Discipline) ? "a Disciplina" : "o curso";			%>
                            <tr> 
                              <td id=headerSimplesFont>&nbsp;Grupo associado com 
                                <%= commKind %> <%= commGroup.getTitle() %></td>
                            </tr>
                            <%     }     %>
                            <tr> 
                            ...
                            <tr> 
                              <td id=headerSimplesFont>&nbsp;Objetivo</td>
                            </tr>
                            <tr> 
                              <td id=corpoSimples>&nbsp;&nbsp; 
                                <textarea name="goal" cols="60" rows="5"></textarea>
                                <br>
                                * Descreva o programa do curso. Poder&aacute; 
                                ser o calend&aacute;rio de aulas ou planejamento 
                                mensal.</td>
                            </tr>
                            <% if ((createAssociatedGroup) && (commGroup.getKind().equals(Community.EXTRA_COURSE)))  {  %>
                            <tr> 
                            ...
                            <tr> 
                              <td id=corpoSimples> &nbsp; 
                                ...
                                &nbsp; 
                                <input type="radio" name="visibility" value="<%= Visibility.PUBLIC %>">
                                Para qualquer usuário. </td>
                            </tr>
                            <%      }      %>
                            <tr> 
                            ...
                            <tr> 
                              <td id=corpoSimples> 
                                <div align="center"> 
                                  <input type="submit" name="Submit" value="Propor Grupo" class="botao">
                                </div>
                              </td>
                            </tr>
                          </table>
