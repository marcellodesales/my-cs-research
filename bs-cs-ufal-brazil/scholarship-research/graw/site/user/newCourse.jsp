...
<%
		...
		String createAcademicCourse = request.getParameter("createCourse");
		boolean createAcademicCourse = (createAcademicCourse.equals("academic");

		AcademicUser academicUser = null;
		boolean hasAcademicPermission = (user instanceof Professor) && createAcademicCourse;		

		if (hasAcademicPermission){	
			academicUser = (AcademicUser) user;		
		} else {
			ServletUtility.sendRedirect(response,ServletUtility.ERROR_GENERIC_PAGE,"Voce nao pode propor um curso acadêmico. Apenas professores podem fazer isso.");
		}
//		
%>
<!-- #EndEditable -->
                  ...
                  <tr>
                    <td><!-- #BeginEditable "information" --> 
                      <p><br>
                        ...
                        informa&ccedil;&otilde;es a respeito dessa nova disciplina.<br>
                      </p>
                      <form action="../servlet/br.ufal.graw.web.user.CreateNewCourse" method="Post">
                        <div align="center"> 						
                          <table width="80%" border="0">
							...
							<%     }     %>
                            <tr> 
                              <td id=headerSimplesFont><%= commsub.getCategory().getDescription() %></td>
                            </tr>
                            <tr> 
                              <td id=headerSimplesFont><%= commsub.getDescription() %></td>
                            </tr>														
                            <tr> 
                              <td id=headerSimplesFont>T&iacute;tulo do Curso 
                                - C&oacute;digo</td>
                            </tr>
                            <tr> 
                              <td id=corpoSimples> 
                            ...
                            <tr> 
                              <td id=headerSimplesFont>Refer&ecirc;ncias bibliogr&aacute;ficas</td>
                            </tr>
                            <tr> 
                              <td id=corpoSimples> 
