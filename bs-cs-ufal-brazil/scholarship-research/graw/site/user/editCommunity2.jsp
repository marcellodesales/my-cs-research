...
<!--  Página que mostra as comunidades de uma subcategoria  Pública
ENTRADA:  subcategoryID.
-->
<%@ page import="java.util.Vector" %>
<%@ page import="br.ufal.graw.Association" %>
<%@ page import="br.ufal.graw.CommunitySubcategory" %>
<TITLE>graW - Gradua&ccedil;&atilde;o na Web - TCI/UFAL - Busca de comunidades</TITLE>
<!-- #EndEditable -->
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --> <br>
                      <%
					CommunitySubcategory subcategory = new CommunitySubcategory(request.getParameter("subcategoryID"),database) ;
					%>
                      <b>Categoria: </b><i><%=subcategory.getCategory().getDescription()%></i><br>
                      <b>Subcategoria: </b><i><%=subcategory.getDescription()%></i><br>
                      <br>
                      <table width="80%" align="center">
                        <tr> 
                          <td id=headerSimplesFont colspan="2">Comunidades:</td>
                        </tr>
                        <%
					Vector communities = subcategory.getPublicCommunities();
					int numberOfElements =  communities.size();						
					System.out.println(numberOfElements);
					Community com;
						for (int i=0 ;  i < numberOfElements ; i++){	
							com = (Community)communities.get(i); %>
                        <tr> 
                          <td><a href="../community/information.jsp?communityID=<%=com.getID()%>"><%=com.getTitle()%></a></td>
                          <td> 
                            <%
