...
<%
		String createAcademicC = request.getParameter("createCourse");
		boolean createAcademicCourse = createAcademicC.equals("academic");
		String category = (createAcademicCourse) ? "Áreas de Conhecimento" : "Categorias";
		session.setAttribute("createAcademicCourse",new Boolean(createAcademicCourse));		
%>
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --><br>
                      Primeiramente escolha uma categoria para o qual seu curso 
                      pertence.<br>
                      <br>
					    <form method="post" action="newCourse2.jsp">
                      <table width="342" border="0" align="center" cellpadding="1" cellspacing="1">
                        <tr> 
                            <td  id=headerSimplesFont>&nbsp;<%= category %></td>
                        </tr>						
                        <tr> 
                          <td id=corpoSimples> &nbsp;&nbsp;
                            <select name='categoryID' style="background-color: #FFCC00">
                              <%
								CommunityCategory[] categories;
									categories = SiteResource.getCommunityCategories(database);
								for (int i=0; i < categories.length; i++){ %>
                        			      <option value='<%=categories[i].getID()%>'><%=categories[i].getDescription()%></option>
