...
String subcategory = (createAcademicCourse) ? "Sub-Áreas de Conhecimento" : "Subcategorias";
%>
<TITLE>graW - Gradua&ccedil;&atilde;o na Web - TCI/UFAL - Proposta de novo Curso</TITLE>
<!-- #EndEditable -->
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --><br>
                      Primeiramente escolha uma categoria para o qual sua disciplina 
                      pertence.<br>
                      <br>
				   <form method="post" action="newCourse3.jsp">
                      <table width="342" border="0" align="center" cellpadding="1" cellspacing="1">
                        <tr> 
                          <td  id=headerSimplesFont><b>&nbsp;<%= new CommunityCategory(categoryID,database).getDescription() %></b></td>
                        </tr>
                        <tr> 
                            <td  id=headerSimplesFont>&nbsp;<%= subcategory %></td>
                        </tr>
                        <tr> 
                          <td id=corpoSimples> &nbsp;&nbsp;
                            <select name='subcategoryID' style="background-color: #FFCC00">
                              <%
								CommunitySubcategory[] subcategories = SiteResource.getSubcategories(categoryID,database);
								for (int i=0; i < subcategories.length; i++){ %>
                        			      <option value='<%=subcategories[i].getID()%>'><%=subcategories[i].getDescription()%></option>
                              <%		}       %>
                            </select>
                          </td>
                        </tr>
                        <tr> 
                          <td id=corpoSimples> 
                            <div align="right"> 
                              <input type="submit" value="Aceitar" name="submit">
                            </div>
                          </td>
                        </tr>
                      </table>
