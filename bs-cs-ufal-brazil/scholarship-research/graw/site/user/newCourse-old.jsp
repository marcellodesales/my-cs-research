                ...
                <table class="tabelaSimples2" cellspacing=0 cellpadding=0 width=100% border=0>
                  <tr> 
                    ...
                    <td  valign=center align=middle height=32 colspan="2">
                      <div  id="textoBlue" align="right"><!-- #BeginEditable "directory" -->Meus 
                        Cursos Criar<!-- #EndEditable -->&nbsp;&nbsp;
                      </div>
                    </td>
                  </tr>
                  <tr> 
			...
			if ( community!=null ){		%>
			  ...
			  <div align="center">
                    <table width="80%" border="0">
                      <tr> 
                        <td id=headerSimples>Nome do curso</td>
                      </tr>
                      <tr> 
                        <td id=corpoSimples> 
					  ...
					  <tr> 
                        <td id=headerSimples>Descrição</td>
                      </tr>
                      <tr> 
                        <td id=corpoSimples> 
                          <textarea name="description" cols="60" rows="4"></textarea>
                          <br>
                          *Uma Breve descrição do  curso.</td>
                      </tr>
                      <tr> 
                        <td id=headerSimples>Programa</td>
                      </tr>
                      <tr> 
                        <td id=corpoSimples> 
                          <textarea name="program" cols="60" rows="5"></textarea>
                          <br>
                          *Descreva o programa do curso.</td>
                      </tr>
                      <tr> 
                        <td id=headerSimples>Refer&ecirc;ncias bibliogr&aacute;ficas</td>
                      </tr>
                      <tr> 
                        <td id=corpoSimples> 
                          <textarea name="references" cols="60" rows="5"></textarea>
                          <br>
                          *Descreva as refer&ecirc;ncias bibliogr&aacute;ficas 
                          do curso.</td>
                      </tr>
                      <tr> 
                        <td id=headerSimples>Carga Hor&aacute;ria 
                          <input type="text" name="hours">
                        </td>
                      </tr>
                      <tr> 
                        <td id=headerSimples>Categoria desse curso</td>
                      </tr>
                      <tr> 
                        <td id=corpoSimples> 
                          <input type="radio" name="category" value="extra" checked>
                          Curso extra curricular. <br>
                          <input type="radio" name="category" value="discipline">
                          Disciplina da grade curricular. C&oacute;digo da Disciplina 
                          <input type="text" name="disciplineCode">
                        </td>
                      </tr>
                      <tr> 
                        <td id=corpoSimples> 
                          <div align="center"> 
                            <input type="submit" name="Submit" value="Cadastrar Curso" class="botao">
                          </div>
                        </td>
                      </tr>
                    </table>
				...
				<div align="right">
					*  A criação deste curso está sujeita à aprovação dos admministradores deste site.
				</div>
				</form>
                <!-- #EndEditable --></td>
                  </tr>
