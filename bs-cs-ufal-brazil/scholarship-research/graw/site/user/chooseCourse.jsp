    ...
    <TABLE class="tabelaMaior" cellSpacing=0 cellPadding=0 width=748 border="0" height="0">
      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
          ...
          no nome de um dos cursos para acessar seus serviços e informações. <br>
          <BR>
          <center>
            <TABLE class=tabelaSimples cellSpacing=0 cellPadding=3 width="61%">
              ...
              <%  
				...
				if ( extraCourses.size() > 0 ){
					...
					<TR >
		    	            <TD id=corpoSimples >
							Você não está associado a nenhum curso Extra-Curricular
							</TD>
		              </TR>	<%
				}	%>
				...
				if ( disciplines.size() > 0 ){
					...
					<TR >
		    	            <TD id=corpoSimples >
							Você não está associado a nenhuma disciplina.
							</TD>
		              </TR>	<%
				}	%>
				<tr>
