                    ...
                    <td  valign=center align=middle height=65 background="../sources/images/gr03.jpg"> 
                      <div  id="textoBlue" align="right"> 
                        <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="0"> 
                              <div align="right"><!-- #BeginEditable "directory" --><b>Convites 
								&#149; Confirmar </b><!-- #EndEditable --></div>
                            </td>
                          </tr>
                          <tr> 
      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
		    ...
		    if (communityGuestsID==null){	    %>
			    Digite o c&oacute;digo 
			      do convite que voc&ecirc; recebeu:<br>
			      <form name="form1" method="post" action="confirmInvitation.jsp">
				<input type="text" name="communityGuestsID">
				<input type="submit" name="Submit" value="Procurar" class="botao">
			      </form><%
			}else{ 
				CommunitySpecialInvitation communitSpecialInvitation=null;
				try{
					communitSpecialInvitation = new CommunitySpecialInvitation(communityGuestsID,database);
				}catch(Exception e){
					ServletUtility.sendRedirect(response,"confirmInvitation.jsp","Convite não encontrado.");
					return;
				}
				session.setAttribute("invitation",communitSpecialInvitation); %>	
				Comunidade: <%=communitSpecialInvitation.getCommunity().getTitle()%><br>
				Convite enviado por: <%=communitSpecialInvitation.getInviter().getName()%>
				<form name="form1" method="post" action="<%=servletDir+"br.ufal.graw.web.user.ConfirmInvitation"%>">					
					<input type="submit" name="Submit" value="Confirmar Convite" class="botao">
			      </form>
			<%
			}
			%>
