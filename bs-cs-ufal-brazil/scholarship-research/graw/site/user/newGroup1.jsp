...
%>
<TITLE>graW - Gradua&ccedil;&atilde;o na Web - TCI/UFAL - Proposta de novo grupo</TITLE>
<!-- #EndEditable -->
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><!-- #BeginEditable "information" --><br>
                      Primeiramente escolha uma disciplina ou um curso extracurricular para o qual seu grupo 
                      pertencer&aacute;. 
                      <br>
                      ...
                      <table width="342" border="0" align="center" cellpadding="1" cellspacing="1">
                        ...
                        <tr> 
                          <td id=corpoSimples> &nbsp;&nbsp;
                              <select name='communityIDGroup' style="background-color: #FFCC00">
                                <%
								Vector disciplines = academicUser.getDisciplines();
								for (int i=0; i < disciplines.size(); i++){     
											Community comm = (Community)disciplines.get(i);		%>
                                <option value='<%=comm.getID()%>'><%=comm.getTitle()%></option>
                              <%		}      %>
                            </select>
                          </td>
                        </tr>
                      ...
                      <table width="342" border="0" align="center" cellpadding="1" cellspacing="1">
                        <tr> 
                            <td  id=headerSimplesFont>Cursos Extracurriculares</td>
                        </tr>						
                        <tr> 
                          <td id=corpoSimples> &nbsp;&nbsp;
                              <select name='communityIDGroup' style="background-color: #FFCC00">
                                <%
								Vector courses = academicUser.getExtraCourses();
								for (int i=0; i < courses.size(); i++){     
											Community course = (Community)courses.get(i);		%>
