      ...
      border=0>
		...
		<table class=tabelaSimples cellspacing=1 cellpadding=3 width="100%">
			...
			%>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              ...
                              <tr> 
                                <td height="14" colspan="4"> 
                                  <ul>
                                    <li>Usuários participantes:<a href="users.jsp"><%=community.getQuantUsers() %></a>	
                                    </li>
                                  </ul>
                                </td>
                              </tr>
                      ...
                      <br>
					  <%
					  	/* Se for um curso, então é possível que ele tenha grupos subordinados a essa comunidade. */
