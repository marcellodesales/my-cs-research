	...
	public void drawMovies(){
		try{
				...
				for (int i = 0; i < comm.length; i++){
					...
					System.out.println("<BR>Título: "+community.getTitle());
					System.out.println("<BR>Responsável: "+community.getResponsible().getName());
					System.out.println("<BR>Instituição: "+new Institute(((Discipline)community).getInstituteID(),database).getName());
					System.out.println("<BR>Departamento: "+new Department(((Discipline)community).getDepartmentID(),database).getName());
					System.out.println("<BR>Usuários: "+community.getQuantUsers());
