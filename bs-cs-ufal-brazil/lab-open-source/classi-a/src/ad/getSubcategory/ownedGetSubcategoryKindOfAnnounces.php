                   ...
                   <td align="center">
                    ...
                    <tr>
                      <TD width="100%" align="center">
                         <form name="kindOfAnnounce" method="post" action="getSubcategory.php" onSubmit="return verifyChoice()">
...
?>      <TR>
          <TD width="130" align="center">
            ...
            if (($idKindOfAnnounce == null) or ($idKindOfAnnounce == 0)){
                  $query = "SELECT $fields FROM t_anuncio WHERE cod_categoria_anuncio=$idCategory AND cod_subcategoria_anuncio=$idSubcategory";
                  $stage = "idCategory=$idCategory&descCategory=$descCategory&idSubcategory=$idSubcategory&descSubcategory=$descSubcategory"; //it's for the indexes
            } else {
                  $query = "SELECT $fields FROM t_anuncio WHERE cod_tipo_anuncio=$idKindOfAnnounce AND cod_categoria_anuncio=$idCategory AND cod_subcategoria_anuncio=$idSubcategory";
                  $stage = "idKindOfAnnounce=$idKindOfAnnounce&descKindOfAnnounce=$descKindOfAnnounce&idCategory=$idCategory&descCategory=$descCategory&idSubcategory=$idSubcategory&descSubcategory=$descSubcategory"; //it's for the indexes
            }
