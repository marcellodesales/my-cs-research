...
<?      require("/classia/ad/getAd/ownedGetAnnounceDir.php");
...
<?
 ...
 ?>
            <P>
            <IMG border=0 height=9 src="/common/images/botton_left.gif" width=134></P></TD></TR>
      </TABLE>
<?
        if ($announce->user->icq != ""){
                require("/classia/ad/getAd/ownedGetAnnounceRefer.php");
        }
?>
   </TD>
    <TD align=middle bgColor=#ffffff rowSpan=3 vAlign=top width=100%>
      ...
      <TABLE border=0 cellPadding=0 cellSpacing=0 height=8>
        <TR>
          <TD align=left><IMG border=0 height=8 src="/common/images/curva_td_left.gif" width=8></TD>
      ...
      <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
        <TR>
          <TD align=middle width="28%">
                <IMG align=left border=0 src="/common/images/logoClassiAAnnounces.gif"></TD>
...
<?  if ($adDoesntExist){ ?>
      ...
      <BR>
<?
        require("/classia/ad/getAd/ownedGetAnnounceIdNotFound.php");
    } else {
?>
      ...
      <BR>
<?
	include("/classia/ad/getAd/ownedGetAnnounceTableAnnounce.php");
    }
?>
...
<BR>          
      ...
      <TR>
         <TD bgColor=#FFCC00 align="center">
            ...
            <p align="center">
            <IMG border=0 height=9 src="/common/images/botton.gif" width=146 valign="bottom"></P>
	</TD></TR></TABLE>
<BR>	
<?
    if (!$adDoesntExist){
	...
	if ($announce->user->icq != ""){
		require("/classia/ad/getAd/ownedGetAnnounceIcqDoubt.php");
	} else {
		require("/classia/ad/getAd/ownedGetAnnounceRefer.php");
	}
   }
