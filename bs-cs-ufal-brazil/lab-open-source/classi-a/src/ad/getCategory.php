...
<HTML><HEAD><TITLE>Classi-A Online / Categorias de anúncios</TITLE>
...
<?
	include("/classia/ad/getCategory/ownedGetCategoryDir.php");// gets the directory information...
...
<?
   require("/classia/ad/getCategory/ownedGetCategoryKindOfAnnounces.php"); // gets the kinds of announce for each idCategory...
?><BR>
...
<? include("/classia/ad/getCategory/ownedGetCategorySubcategories.php"); //returns the subcategories of this category....
?>    
        </center>
      </div>
