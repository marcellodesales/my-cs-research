...
<HTML><HEAD><TITLE>Classi-A Online / Especificações de anúncios</TITLE>
...
<?
	include("/classia/ad/getEspecification/ownedGetEspecificationDir.php");
...
<?    include("/classia/ad/getEspecification/ownedGetEspecificationKindOfAnnounces.php");  // gets the kinds of announce for each idEspecification...
...
?>   
    ...
    <TD align=middle bgColor=#ffffff rowSpan=3 vAlign=top width="100%">
      ...
      <div align="center"><center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td width="28%" align="center"><img border="0" src="/common/images/logoClassiAAnnounces.gif" align="left"></td>
...
<?     require("/classia/common/commonCopyright.php");    ?>      
    ...
    <TD bgColor=#ffffff vAlign=top width=147>
      <TABLE border=0 cellPadding=0 cellSpacing=0 width=100% height="1">
		...
		<? require("/classia/common/commonHowLogin.php"); ?>
