...
<HTML><HEAD><TITLE>Classi-A Online / </TITLE>
...
<?
	...
	include("/classia/ad/getSubcategory/ownedGetSubcategoryDir.php");
...
<? include("/classia/ad/getSubcategory/ownedGetSubcategoryKindOfAnnounces.php"); // gets the kinds of announce for each idCategory...

   include("/classia/common/banners/banners.php");
   
?>   
            </center>
            <p><img border="0" src="/common/images/botton_left.gif" width="134" height="9"></P>
      </TD></TR>
     </TBODY>
    </TABLE>
...
<? include("/classia/ad/getSubcategory/ownedGetSubcategoryEspecifications.php"); //returns the subcategories of this category....
?>
        </center>
      </div>

<?   include("/classia/common/commonGetResultDescription.php"); ?>
...
<?
  ...
  if ($lines != 0){
	...
	include("/classia/common/commonGetAnnounce.php");
...
<?     require("/classia/common/commonCopyright.php");    ?>
    ...
    <TD bgColor=#ffffff vAlign=top width=147>
      ...
      <tr>	
		...
		<? require("/classia/common/commonCategoriesChoices.php"); ?>
...
<?
//require("/classia/common/commonSmallBusiness.php");
//require("/classia/common/commonDoubtsQuestions.php");
