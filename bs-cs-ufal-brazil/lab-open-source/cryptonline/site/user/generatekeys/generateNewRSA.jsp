...
try{
	...
	user.changeRSA();
	Iterator it = user.getRsa().getLog();
%>
      ...
      <table width="90%" border="0" align="center">
        <tr> 
          <td width="28%" valign=top><br>
            <a href="generateNewRSA.jsp"><img src="../../sources/image/keys.gif" width="64" height="49" border="0" alt="Gerar novas chaves!"></a> 
            Chaves de Acesso<br>
            <br>
          ...
          <td width="72%" valign="top"><!-- #BeginEditable "userContent" --> 
            <p><b><i><font size="3">Gerar Chaves </font></i></b><br>
              <font face="Courier New, Courier, mono">
              <%
		while (it.hasNext()){
			String logLine = (String)it.next();
			out.println("<BR>"+logLine);
		}
		%>
              </font></p>
            <!-- #EndEditable --></td>
