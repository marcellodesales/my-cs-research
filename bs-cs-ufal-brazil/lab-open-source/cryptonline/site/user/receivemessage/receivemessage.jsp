      ...
      <table width="90%" border="0" align="center">
        <tr> 
          <td width="28%" valign=top><br>
            ...
            Receber Mensagem</td>
          <td width="72%" valign="top"><!-- #BeginEditable "userContent" --><b><i><font size="3">Receber 
            mensagem<br>
            <br>
            </font></i></b>
             
            <form name="form1" method="post" action="receiveCriptedMessage.jsp">
              <table width="94%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td>Mensagem criptografada</td>
              </tr>
              <tr> 
                <td>
                  <textarea name="criptedMessage" cols="50" rows="10"></textarea>
                </td>
              </tr>
              <tr>
                <td>
            ...
            <b><i><font size="3"> </font></i></b><!-- #EndEditable --></td>
        </tr>
      </table>
    </td>
  </tr>
