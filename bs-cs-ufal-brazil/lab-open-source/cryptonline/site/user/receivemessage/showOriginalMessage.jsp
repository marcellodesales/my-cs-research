...
try{
	...
	Iterator it = (Iterator)session.getAttribute("receiveMessageLog");
	String originalMessage = (String)session.getAttribute("originalMessage");	
%>
      ...
      <table width="90%" border="0" align="center">
        <tr> 
          <td width="28%" valign=top><br>
            ...
            Chaves de Acesso<br>
            <br>
            <a href="../sendmessage/sendMessage.jsp"><img src="../../sources/image/mailbinary.gif" width="60" height="35" border="0"></a> 
            Enviar Mensagem<br>
            <br>
            <a href="receivemessage.jsp"><img src="../../sources/image/binarymail.gif" width="60" height="35" border="0"></a> 
            Receber Mensagem</td>
          <td width="72%" valign="top"><!-- #BeginEditable "userContent" -->
            <div align="center"><b><i><b><font size="2">Mensagem Original!</font></b></i><br>
              <textarea name="textfield" cols="70" rows="5"><%= originalMessage %></textarea>
              <br>
              <i><b><font size="2">Calculos realizados!</font></b></i> <br>
              <textarea name="textarea" cols="70" rows="10">
<%
				while (it.hasNext()){
