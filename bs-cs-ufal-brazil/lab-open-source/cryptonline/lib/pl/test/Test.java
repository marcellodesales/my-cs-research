...
public class Test {
    ...
    public void performTest()
    {
        try
        {
            ...
            String dir = "C:\\download\\camadaPersistencia\\test\\";
            // Load database
			...
			System.out.println("Instanciacao- getName= "+person.getName());
           // person.setName("Test person 1");
			person.setName("Test person 2");
			
			System.out.println("setName- getName= "+person.getName());
            // Insert object
            //person.save();
            // Update object
			//System.out.println("save - getName= "+person.getName());
            //person.setName("Test person 2");
			//System.out.println("setName - getName= "+person.getName());
            //person.save();
			//System.out.println("save - getName= "+person.getName());
            // Retrieve object
			person.setPersistent(true);
            person.retrieve();
			
			System.out.println(person.isPersistent());
			System.out.println("retrieve - getName= "+person.getName());
			System.out.println("retrieve - getID= "+person.getId());
            // Lock object
            person.lock();
            // Delete object
            //person.delete();
