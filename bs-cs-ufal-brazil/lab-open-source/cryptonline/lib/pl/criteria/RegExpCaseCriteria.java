...
public class RegExpCaseCriteria extends SelectionCriteria
{

  public RegExpCaseCriteria(pl.map.ClassMap classMap, pl.map.AttributeMap attributeMap)
  {
