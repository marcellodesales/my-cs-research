 ...
 * @author: Artyom Rudoy
 */
public class GreaterThanOrEqualToCriteria extends SelectionCriteria
{
    public GreaterThanOrEqualToCriteria(pl.map.ClassMap classMap, pl.map.AttributeMap attributeMap)
    {
