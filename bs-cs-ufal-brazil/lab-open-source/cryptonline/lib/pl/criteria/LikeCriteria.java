 ...
 * @author: Artyom Rudoy
 */
public class LikeCriteria extends SelectionCriteria
{
    public LikeCriteria(pl.map.ClassMap classMap, pl.map.AttributeMap attributeMap)
    {
    ...
    public void fillSqlStatement(pl.sql.SqlStatement statement, java.util.Iterator parameters) throws pl.PlException
    {
        ...
        getClassMap().getRelationalDatabase().getClauseStringLike() + " ?");
