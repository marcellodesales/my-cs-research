...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21" width="652"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" -->Grupo 
      de usu&aacute;rios<!-- #EndEditable --></b></font></td>
  ...
  <tr valign="top"> 
    <td height="276" colspan="2"> <!-- #BeginEditable "centro" --> <p><br>
      </p><form action="listUsers2.jsp" method="POST">
        <table width="520" border="0" align="center" cellpadding="1" cellspacing="1">
          ...
          <tr> 
            <td id=corpoSimples>&nbsp;&nbsp;<select name='groupID' style="background-color: #FFCC00">
<%
		Group[] groups = ComponentSet.getGroups(databaseLayer);
		for (int i=0; i < groups.length; i++){ %>
                <option value='<%=groups[i].getID()%>'><%=groups[i].getDescription()%></option>
<%		}
%>
              </select></td>
          </tr>
      ...
      <br>
      <a href="../index.jsp">Voltar a p&aacute;gina principal</a>.
      <!-- #EndEditable --> 
    </td>
  </tr>
  <tr class="escuro"> 
