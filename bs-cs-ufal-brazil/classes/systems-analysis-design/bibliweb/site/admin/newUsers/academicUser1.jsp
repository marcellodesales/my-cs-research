...
<title>Cadastro de novo usuário acadêmico! / </title>
<!-- #EndEditable -->
...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21" width="652"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" -->Cadastro 
      de usu&aacute;rio acad&ecirc;mico<!-- #EndEditable --></b></font></td>
  ...
  <tr valign="top"> 
    <td height="276" colspan="2"> <!-- #BeginEditable "centro" --> <br>
      Primeiramente escolha um curso acad&ecirc;mico do usu&aacute;rio.<br>
      <br>
