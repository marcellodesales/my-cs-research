...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21" width="652"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" --> 
      &nbsp;Centro de administra&ccedil;&atilde;o Bibliweb<!-- #EndEditable --></b></font></td>
  ...
  <tr valign="top"> 
    <td height="276" colspan="2"> <!-- #BeginEditable "centro" --><br>
      <ul>
        <li><a href="users/listUsers.jsp">Listar usu&aacute;rios cadastrados</a>;</li>
        <li><a href="newusers/index.jsp">Cadastro de novos usu&aacute;rios;</a></li>
        <li><a href="exemplars/listExemplars.jsp">Listar livros cadastrados</a>;</li>
        <li><a href="newexemplars/index.jsp">Cadastro de novos exemplares</a>;</li>
        <li><a href="lends/index.jsp">Empr&eacute;stimos</a>;</li>
        <li>Busca de Exemplar.</li>
        <li></li>
      </ul>
	  <BR>
      <!-- #EndEditable --> </td>
