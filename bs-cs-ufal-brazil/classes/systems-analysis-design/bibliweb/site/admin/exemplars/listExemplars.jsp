...
<title>Seja Bem-Vindo ao BibliWEB! - Lista de exemplares</title>
<!-- #EndEditable -->
...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21" width="652"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" -->Lista 
      de exemplares<!-- #EndEditable --></b></font></td>
...
%>
      ...
      <form action="listExemplars2.jsp" method="POST">
