...
<title>Lista de cópias de exemplar</title>
<!-- #EndEditable -->
...
<table class="tabelaMaior" width="770" border="0" cellspacing="2" cellpadding="1" align="center" height="426">
  ...
  <tr class="escuro"> 
    <td height="21" width="652"><font color=white size=2 face=verdana><b><!-- #BeginEditable "title" -->Cópias do exemplar<!-- #EndEditable --></b></font></td>
        ...
        <tr>
          <td width="86%"> 
            <table width="520" border="0" align="center" cellpadding="1" cellspacing="1">
              <tr> 
                <td id=headerSimplesFont>Lista de cópias de exemplares</td>
              </tr>
              <%
		ExemplarCopy[] exemplars = ComponentSet.getExemplarCopies(exemplarID,databaseLayer);
	if (exemplars.length > 0){
		for (int i=0; i < exemplars.length; i++){ %>
              <tr> 
                <td id=corpoSimples>&nbsp;&nbsp; <a href="../exemplarcopies/exemplarcopy.jsp?copyID=<%= exemplars[i].getID() %>"><%= exemplars[i].getID()%> 
                  - <%= exemplars[i].getStatus().getDescription()%></a></td>
              </tr>
              <%		} 
 	} else {     %>
              <tr> 
                <td> 
                  <div align="center"><font color="red">&nbsp;&nbsp;Ainda não 
                    existem cópias de exemplares!</font></div>
                </td>
              </tr>
              <%		}      %>
              <tr> 
