...
public class Group{
	...
	/** Código para identificar o grupo de estudantes universitários: "S" */
	public static final String STUDENT_CODE   = "S";
	/** Código para identificar o grupo de professores universitários: "P" */
	public static final String PROFESSOR_CODE = "P";
	/** Código para identificar o grupo de balconistas: "C" */
	public static final String CLERK_CODE     = "C";
	/** Código para identificar o grupo de administradores: "A" */
	public static final String ADMIN_CODE     = "A";
	/** Código para identificar o grupo de distribuidores: "D" */
	...
	/** Verifica se um grupo existe a partir da identificação groupID. */
