...
public class JMain extends JFrame implements ActionListener{
      ...
      private JPanel basePanel,
                     ...
                     animationPanel,
                     informationPanel,
                     speedPanel, anglePanel, gravityPanel, reachPanel,mHeightPanel,
                     spaceBoxPanel,situationPanel,
                     confResPanel, configPanel, resultPanel;
	...
	private int situation = 0; //0 - situacao 0...
  ...
  /** Sets the oblique launch values into the thrower and environment object. */
  /*private void setObliqueLaunchValues(double initialSpeed, int angle, double gravity){
      this.world.setGravity(gravity);
      this.cannon.setGravity(this.world.getGravity(), this.ball);
      this.cannon.setAngle(angle, this.ball);
  ...
  public void setInitialValues(){
      ...
      //this.quantLabel.setText(this.stringQuantLaunches);
  }
  ...
  public void setSituationValuesFromSpaceComboBox(JComboBox situationDescComboBox){
      ...
      switch (environmentChosen){
        case 0 : {
				  value = "Os valores de entrada são Velocidade Inicial, Ângulo e Gravidade, para ser"
				  		+" encontrado o Alcance e Altura Máxima, além do tempo para ambos.";
			  ...
			  break;
        case 1 :{
				  value = "Os valores de entrada são Velocidade Inicial, Gravidade e Alcance, para ser"
				  		+" encontrado o Angulo e Altura Máxima, além do tempo para ambos.";
				  this.enableAllFields();
			  ...
			  break;
		case 2 : {
				  value = "Os valores de entrada são Gravidade, Ângulo e Alcance, para ser"
				  		+" encontrado a Velocidade Inicial e Altura Máxima além do tempo.";
				  this.enableAllFields();
			  ...
			  break;
		case 3 : {
				  value = "Os valores de entrada são Gravidade, Alcance e Altura Máxima, para ser"
				  		+" encontrado o Ângulo e Velocidade Inicial, além do tempo.";
				  this.enableAllFields();
				  this.disableObject(this.speedField);
				  this.disableObject(this.angleSlider.text);
				  this.angleSlider.slider.disable();
  ...
  public static void main(String[] args){
	  ...
	  System.out.println("Lançamento Oblíquo - Julho de 2002");
	  System.out.println("* Augusto César Melo de Oliveira - 1999G55D007V-1");
