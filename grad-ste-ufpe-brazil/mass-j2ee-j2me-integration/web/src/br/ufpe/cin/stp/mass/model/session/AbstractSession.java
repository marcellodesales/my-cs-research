...
public abstract class AbstractSession extends Persistent implements Session {
	...
	/* (non-Javadoc)
	 * @see br.ufpe.cin.stp.mass.model.Session#getAnswers()
	 */
	public Iterator getAnswers(){
	    return this.answers.iterator();
	}
	
	/* @created 01/07/2004 22:48:43
	 * (non-Javadoc)
	 * @see br.ufpe.cin.stp.mass.model.session.Session#numberOfAnswers()
	 */
	...
	public void addAnswer(Answer answer) throws SessionClosedException{
	    ...
	    else throw new SessionClosedException("This session is already closed and impossible to receive votes.",this);
	}
    ...
    /* @created 01/07/2004 23:48:37
     * (non-Javadoc)
     * @see br.ufpe.cin.stp.mass.model.session.Session#closeSession()
     */
